...
\paragraph{} For example: sets $\{p, q\}$ and $\{p, q, s\}$ extend $<\{p, q\}, \{r\}>$ but not neither $\{p\}$ nor $\{p, q, r\}$ do. In LAS, examples are covered if there exists an Answer Set of $B \cup H$ which extends the example (as a partial interpretation).
