...
\begin{document}
  ...
  \paragraph{} This reference also contain several contributions - in no particular order - from Aaron Hau and Sagar Doshi. Thank you for your contirbution.
  ...
  \paragraph{} Comments can be written in a Prolog file by using the $\%$ character at the beginning of the comment. All characters following the $\%$ character until the newline character are ignored by Prolog.
