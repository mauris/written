...
\begin{itemize}
\item $\Delta \subset Ab$ - $\Delta$ belongs to a predefined language of abducibles.
...
\paragraph{} Let $<KB, Ab, IC>$ be an abductive model expressed in Normal Clausal Logic and let $O$ be a ground observation:
...
Learning from entailment means $\forall e \in E, B \cup H_i \models e$
