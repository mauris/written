...
\paragraph{} Consider the following SLP $P$ over natural numbers:
...
\paragraph{} It is also possible to build a SLP $Q$ that describes a polynomial distribution over natural numbers in reverse binary form\cite[pp. 8-9]{muggleton96}. Numbers are constructed by
